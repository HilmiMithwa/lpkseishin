...
<head>
    ...
    <title>Pembayaran - LPK Seishin</title>
        ...
        <main class="flex-1 bg-white rounded-t-[20px] lg:rounded-[40px] mr-0 lg:mr-8 mb-0 lg:mb-8 overflow-y-auto shadow-sm custom-scrollbar relative flex flex-col">
            <div class="p-6 lg:p-10">
                ...
                <div class="mb-8 text-left">
                    <h1 class="text-3xl lg:text-4xl font-black text-[#444444] tracking-tight">Pembayaran</h1>
                    <p class="text-xs lg:text-sm font-bold text-[#666666] mt-2">Kelola tagihan SPP, metode pembayaran, dan riwayat transaksi.</p>
                </div>
                ...
                @if(!$isFullyPaid)
                    <div class="bg-white border border-gray-100 rounded-[32px] p-6 lg:p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] mb-10 flex flex-col gap-4 lg:gap-6">
                        ...
                        <div class="flex justify-between items-center w-full">
                            ...
                            <span class="text-sm font-black text-[#DB2A2A]">Jatuh Tempo: {{ $activeBill->due_date }}</span>
                        </div>
