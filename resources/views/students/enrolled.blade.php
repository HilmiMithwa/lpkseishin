...
<div class="p-4 sm:p-6 lg:p-10">
    ...
    <div class="mb-6 text-left">
        <h1 class="text-xl sm:text-2xl lg:text-[28px] font-bold font-ibm text-[#222222] tracking-tight mb-1">Terdaftar</h1>
        <p class="text-sm text-[#666666] font-medium">Ruang Belajarmu</p>
    </div>
