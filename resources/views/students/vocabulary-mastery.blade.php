...
<head>
    ...
    <title>Penguasaan Kosakata - LPK Seishin</title>
...
<body class="bg-[#FFF9F4] text-[#222222] h-screen flex overflow-hidden">
    ...
    <button id="mobile-menu-close" class="fixed top-4 right-4 z-50 hidden lg:hidden p-2 bg-[#222222] text-white rounded-lg">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 bg-white rounded-t-[20px] lg:rounded-[40px] mr-0 lg:mr-8 mb-0 lg:mb-8 overflow-y-auto shadow-sm custom-scrollbar">
            <div class="p-4 sm:p-6 lg:p-10 space-y-8">
                ...
                <div class="text-left">
                    <h1 class="text-2xl lg:text-3xl font-black text-[#222222] tracking-tight">Penguasaan Kosakata</h1>
                    <p class="text-xs font-bold text-[#666666] uppercase tracking-wider mt-1">Penguasaan Kosakata</p>
                </div>
