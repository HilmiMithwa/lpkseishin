    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="xl:col-span-1">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 sm:p-8 shadow-sm">
                ...
                <a href="{{ asset('storage/' . $task->file_path_tugas) }}" target="_blank" class="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-red-300 transition group bg-gray-50/50">
