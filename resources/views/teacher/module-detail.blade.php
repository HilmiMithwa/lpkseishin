...
<div class="p-4 sm:p-6 lg:p-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-xl sm:text-2xl lg:text-[26px] font-bold font-ibm text-gray-900 tracking-tight mb-1">{{ $moduleTitle }}</h1>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-white border border-gray-100 rounded-xl p-4 shadow-sm hover:shadow-md transition flex items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-1.5">
                                    <button class="inline-flex items-center gap-1.5 bg-[#d62828] hover:bg-red-700 text-white font-bold font-karla py-1.5 px-3 rounded-lg text-xs transition shadow-sm">
                                        Lihat
        ...
        <div class="lg:col-span-1">
            <div class="bg-white border border-gray-100 rounded-2xl lg:rounded-3xl p-5 shadow-sm sticky top-6">
                ...
                <div class="space-y-2">
                    ...
                    <button x-data @click="$dispatch('open-add-module-modal')" class="w-full mt-2 py-3 px-4 border-2 border-dashed border-red-200 hover:border-[#d62828] hover:bg-red-50 rounded-xl text-[#d62828] font-bold font-karla text-xs flex items-center justify-center gap-2 transition">
