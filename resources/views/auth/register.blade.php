<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            <input 
                id="name" 
                class="block w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500/20 focus:border-red-400 focus:bg-white transition-all duration-200 placeholder-gray-400 @error('name') border-red-400 bg-red-50 @enderror" 
                type="text" 
                name="name" 
                :value="old('name')" 
                required 
