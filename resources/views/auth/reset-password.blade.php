<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <input 
                id="email" 
                class="block w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all duration-200 placeholder-gray-400 @error('email') border-red-400 bg-red-50 @enderror" 
                type="email" 
                name="email" 
