            ...
            return \Yajra\DataTables\Facades\DataTables::of($query)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    return '<div class="flex items-center justify-center gap-2">
                                ...
                                <button onclick="window.dispatchEvent(new CustomEvent(\'open-delete-user-modal\', { detail: { id: ' . $row->id . ' } }))" class="p-1.5 text-slate-400 hover:text-rose-600 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-rose-50 transition" title="Hapus">
